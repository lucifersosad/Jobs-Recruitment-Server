...
//Hàm này gửi mail thông báo cho nhà tuyển dụng khi có ứng viên ứng tuyển vào công việc
export const sendMailEmployerAcceptCv = (
  email: string,
  subject: string,
  record: any
): void => {
  //biến này dùng để gửi mail thông báo cho nhà tuyển dụng khi có ứng viên ứng tuyển vào công việc
  const transporter = nodemailer.createTransport({
    service: "gmail",
    auth: {
      user: process.env.EMAIL_USER,
            ...
            >
              ...
              <p>
                ...
                <strong style="color: #ff3f8c"
                  >${record?.employerId?.companyName}</strong
...
//Hàm này gửi mail thông báo từ chối CV
export const sendMailEmployerRefureCv = (
  email: string,
  subject: string,
  record: any
): void => {
          ...
          <div class="content" style="text-align: center">
            ...
            >
              ...
              <p>
                ...
                thời điểm hiện tại
                <strong style="color: #ff3f8c">${record?.employerId?.companyName}</strong> chưa

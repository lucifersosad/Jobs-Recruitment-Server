...
const controller = __importStar(require("../../controllers/locations/locations.controller"));
const validates = __importStar(require("../../validates/locations/locations.validate"));
const middleware = __importStar(require("../../middlewares/employers/auth.middleware"));
